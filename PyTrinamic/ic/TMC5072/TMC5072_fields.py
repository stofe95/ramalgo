...
class TMC5072_fields(object):
	...
	# PWMCONF_M1
	PWM_AMPL          = [( 0x10, 0x000000FF,  0 ), ( 0x18, 0x000000FF,  0 )]# PWMCONF_M1
	PWM_GRAD           = [( 0x10, 0x0000FF00,  8 ), ( 0x18, 0x0000FF00,  8 )] # PWMCONF_M1
	PWM_FREQ           = [( 0x10, 0x00030000, 16 ), ( 0x18, 0x00030000, 16 )]  # PWMCONF_M1
	PWM_AUTOSCALE      = [( 0x10, 0x00040000, 18 ), ( 0x18, 0x00040000, 18 )] # PWMCONF_M1
	PWM_SYMMETRIC      = [( 0x10, 0x00080000, 19 ), ( 0x18, 0x00080000, 19 ) ] # PWMCONF_M1
	FREEWHEEL          = [( 0x10, 0x00300000, 20 ), ( 0x18, 0x00300000, 20 )] # PWMCONF_M1
	PWM_AMPL           = [( 0x10, 0x000000FF,  0 ), ( 0x18, 0x000000FF,  0 )] # PWMCONF_M1
	PWM_GRAD           = [( 0x10, 0x0000FF00,  8 ), ( 0x18, 0x0000FF00,  8 ) ] # PWMCONF_M1
	PWM_FREQ           = [( 0x10, 0x00030000, 16 ),  (0x18, 0x00030000, 16 )] # PWMCONF_M1
	PWM_AUTOSCALE      = [( 0x10, 0x00040000, 18 ),  (0x18, 0x00040000, 18 )] # PWMCONF_M1
	...
	# PWM_STATUS_M1
	PWM_STATUS         = [( 0x11, 0x000000FF,  0 ), ( 0x19, 0x000000FF,  0 )] # PWM_STATUS_M1
	...
	# M1
	RAMPMODE           = [( 0x20, 0x00000003,  0 ), ( 0x40, 0x00000003,  0 )]  # RAMPMODE_M1
	XACTUAL            = [( 0x21, 0xFFFFFFFF,  0 ), ( 0x41, 0xFFFFFFFF,  0 )] # XACTUAL_M1
	VACTUAL            = [( 0x22, 0x00FFFFFF,  0 ), ( 0x42, 0x00FFFFFF,  0 )] # VACTUAL_M1
	VSTART             = [( 0x23, 0x0003FFFF,  0 ), ( 0x43, 0x0003FFFF,  0 )] # VSTART_M1
	A1                 = [( 0x24, 0x0000FFFF,  0 ), ( 0x44, 0x0000FFFF,  0 )] # A1_M1
	V1_                = [( 0x25, 0x000FFFFF,  0 ), ( 0x45, 0x000FFFFF,  0 )] # V1_M1
	AMAX               = [( 0x26, 0x0000FFFF,  0 ), ( 0x46, 0x0000FFFF,  0 )] # AMAX_M1
	VMAX               = [( 0x27, 0x007FFFFF,  0 ), ( 0x47, 0x007FFFFF,  0 )] # VMAX_M1
	DMAX               = [( 0x28, 0x0000FFFF,  0 ), ( 0x48, 0x0000FFFF,  0 )] # DMAX_M1
	D1                 = [( 0x2A, 0x0000FFFF,  0 ), ( 0x4A, 0x0000FFFF,  0 )] # D1_M1
	VSTOP              = [( 0x2B, 0x0003FFFF,  0 ), ( 0x4B, 0x0003FFFF,  0 )] # VSTOP_M1
	TZEROWAIT          = [( 0x2C, 0x0000FFFF,  0 ), ( 0x4C, 0x0000FFFF,  0 )] # TZEROWAIT_M1
	XTARGET            = [( 0x2D, 0xFFFFFFFF,  0 ), ( 0x4D, 0xFFFFFFFF,  0 )] # XTARGET_M1
	...
	# M1
	IHOLD              = [( 0x30, 0x0000001F,  0 ), ( 0x50, 0x0000001F,  0 )] # IHOLD_IRUN_M1
	IRUN               = [( 0x30, 0x00001F00,  8 ), ( 0x50, 0x00001F00,  8 )] # IHOLD_IRUN_M1
	IHOLDDELAY         = [( 0x30, 0x000F0000, 16 ), ( 0x50, 0x000F0000, 16 )] # IHOLD_IRUN_M1
	VCOOLTHRS          = [( 0x31, 0x007FFFFF,  0 ), ( 0x51, 0x007FFFFF,  0 )] # VCOOLTHRS_M1
	VHIGH              = [( 0x32, 0x007FFFFF,  0 ), ( 0x52, 0x007FFFFF,  0 )] # VHIGH_M1
	VDCMIN             = [( 0x33, 0x007FFFFF,  0 ), ( 0x53, 0x007FFFFF,  0 )] # VDCMIN_M1
	STOP_L_ENABLE      = [( 0x34, 0x00000001,  0 ), ( 0x54, 0x00000001,  0 )] # SW_MODE_M1
	STOP_R_ENABLE      = [( 0x34, 0x00000002,  1 ), ( 0x54, 0x00000002,  1 )] # SW_MODE_M1
	POL_STOP_L         = [( 0x34, 0x00000004,  2 ), ( 0x54, 0x00000004,  2 )] # SW_MODE_M1
	POL_STOP_R         = [( 0x34, 0x00000008,  3 ), ( 0x54, 0x00000008,  3 )] # SW_MODE_M1
	SWAP_LR            = [( 0x34, 0x00000010,  4 ), ( 0x54, 0x00000010,  4 )] # SW_MODE_M1
	LATCH_L_ACTIVE     = [( 0x34, 0x00000020,  5 ), ( 0x54, 0x00000020,  5 )] # SW_MODE_M1
	LATCH_L_INACTIVE   = [( 0x34, 0x00000040,  6 ), ( 0x54, 0x00000040,  6 )] # SW_MODE_M1
	LATCH_R_ACTIVE     = [( 0x34, 0x00000080,  7 ), ( 0x54, 0x00000080,  7 )] # SW_MODE_M1
	LATCH_R_INACTIVE   = [( 0x34, 0x00000100,  8 ), ( 0x54, 0x00000100,  8 )] # SW_MODE_M1
	EN_LATCH_ENCODER   = [( 0x34, 0x00000200,  9 ), ( 0x54, 0x00000200,  9 )] # SW_MODE_M1
	SG_STOP            = [( 0x34, 0x00000400, 10 ), ( 0x54, 0x00000400, 10 )] # SW_MODE_M1
	EN_SOFTSTOP        = [( 0x34, 0x00000800, 11 ), ( 0x54, 0x00000800, 11 )] # SW_MODE_M1
	STATUS_STOP_L      = [( 0x35, 0x00000001,  0 ), ( 0x55, 0x00000001,  0 )] # RAMP_STAT_M1
	STATUS_STOP_R      = [( 0x35, 0x00000002,  1 ), ( 0x55, 0x00000002,  1 )] # RAMP_STAT_M1
	STATUS_LATCH_L     = [( 0x35, 0x00000004,  2 ), ( 0x55, 0x00000004,  2 )] # RAMP_STAT_M1
	STATUS_LATCH_R     = [( 0x35, 0x00000008,  3 ), ( 0x55, 0x00000008,  3 )] # RAMP_STAT_M1
	EVENT_STOP_L       = [( 0x35, 0x00000010,  4 ), ( 0x55, 0x00000010,  4 )] # RAMP_STAT_M1
	EVENT_STOP_R       = [( 0x35, 0x00000020,  5 ), ( 0x55, 0x00000020,  5 )] # RAMP_STAT_M1
	EVENT_STOP_SG      = [( 0x35, 0x00000040,  6 ), ( 0x55, 0x00000040,  6 )] # RAMP_STAT_M1
	EVENT_POS_REACHED  = [( 0x35, 0x00000080,  7 ), ( 0x55, 0x00000080,  7 )] # RAMP_STAT_M1
	VELOCITY_REACHED   = [( 0x35, 0x00000100,  8 ), ( 0x55, 0x00000100,  8 )] # RAMP_STAT_M1
	POSITION_REACHED   = [( 0x35, 0x00000200,  9 ), ( 0x55, 0x00000200,  9 )] # RAMP_STAT_M1
	VZERO              = [( 0x35, 0x00000400, 10 ), ( 0x55, 0x00000400, 10 )] # RAMP_STAT_M1
	T_ZEROWAIT_ACTIVE  = [( 0x35, 0x00000800, 11 ), ( 0x55, 0x00000800, 11 )] # RAMP_STAT_M1
	SECOND_MOVE        = [( 0x35, 0x00001000, 12 ), ( 0x55, 0x00001000, 12 )] # RAMP_STAT_M1
	STATUS_SG          = [( 0x35, 0x00002000, 13 ), ( 0x55, 0x00002000, 13 )] # RAMP_STAT_M1
	XLATCH             = [( 0x36, 0xFFFFFFFF,  0 ), ( 0x56, 0xFFFFFFFF,  0 )] # XLATCH_M1
	...
	# ENCMODE_M1
	POL_A              = [( 0x38, 0x00000001,  0 ), ( 0x58, 0x00000001,  0 )] # ENCMODE_M1
	POL_B              = [( 0x38, 0x00000002,  1 ), ( 0x58, 0x00000002,  1 )] # ENCMODE_M1
	POL_N              = [( 0x38, 0x00000004,  2 ), ( 0x58, 0x00000004,  2 )] # ENCMODE_M1
	IGNORE_AB          = [( 0x38, 0x00000008,  3 ), ( 0x58, 0x00000008,  3 )] # ENCMODE_M1
	CLR_CONT           = [( 0x38, 0x00000010,  4 ), ( 0x58, 0x00000010,  4 )] # ENCMODE_M1
	CLR_ONCE           = [( 0x38, 0x00000020,  5 ), ( 0x58, 0x00000020,  5 )] # ENCMODE_M1
	POS_EDGE_NEG_EDGE  = [( 0x38, 0x000000C0,  6 ), ( 0x58, 0x000000C0,  6 )] # ENCMODE_M1
	CLR_ENC_X          = [( 0x38, 0x00000100,  8 ), ( 0x58, 0x00000100,  8 )] # ENCMODE_M1
	LATCH_X_ACT        = [( 0x38, 0x00000200,  9 ), ( 0x58, 0x00000200,  9 )] # ENCMODE_M1
	ENC_SEL_DECIMAL    = [( 0x38, 0x00000400, 10 ), ( 0x58, 0x00000400, 10 )] # ENCMODE_M1
	LATCH_NOW_         = [( 0x38, 0x00000800, 11 ), ( 0x58, 0x00000800, 11 )] # ENCMODE_M1
	...
	# MSCNT_M1
	MSCNT              = [( 0x6A, 0x000003FF,  0 ), ( 0x7A, 0x000003FF,  0 )]  # MSCNT_M1

	# MSCURACT_M1
	CUR_A              = [( 0x6B, 0x000001FF,  0 ), ( 0x7B, 0x000001FF,  0 )] # MSCURACT_M1
	CUR_B              = [( 0x6B, 0x01FF0000, 16 ), ( 0x7B, 0x01FF0000, 16 )] # MSCURACT_M1

	# CHOPCONF_M1
	TOFF               = [( 0x6C, 0x0000000F,  0 ) , ( 0x7C, 0x0000000F,  0 )] # CHOPCONF_M1
	TFD_2__0_          = [( 0x6C, 0x00000070,  4 ) , ( 0x7C, 0x00000070,  4 )] # CHOPCONF_M1
	OFFSET             = [( 0x6C, 0x00000780,  7 ) , ( 0x7C, 0x00000780,  7 )] # CHOPCONF_M1
	TFD__              = [( 0x6C, 0x00000800, 11 ) , ( 0x7C, 0x00000800, 11 )] # CHOPCONF_M1
	DISFDCC            = [( 0x6C, 0x00001000, 12 ) , ( 0x7C, 0x00001000, 12 )] # CHOPCONF_M1
	RNDTF              = [( 0x6C, 0x00002000, 13 ) , ( 0x7C, 0x00002000, 13 )] # CHOPCONF_M1
	CHM                = [( 0x6C, 0x00004000, 14 ) , ( 0x7C, 0x00004000, 14 )] # CHOPCONF_M1
	TBL                = [( 0x6C, 0x00018000, 15 ) , ( 0x7C, 0x00018000, 15 )] # CHOPCONF_M1
	VSENSE             = [( 0x6C, 0x00020000, 17 ) , ( 0x7C, 0x00020000, 17 )] # CHOPCONF_M1
	VHIGHFS            = [( 0x6C, 0x00040000, 18 ) , ( 0x7C, 0x00040000, 18 )] # CHOPCONF_M1
	VHIGHCHM           = [( 0x6C, 0x00080000, 19 ) , ( 0x7C, 0x00080000, 19 )] # CHOPCONF_M1
	MRES               = [( 0x6C, 0x0F000000, 24 ) , ( 0x7C, 0x0F000000, 24 )] # CHOPCONF_M1
	INTPOL             = [( 0x6C, 0x10000000, 28 ) , ( 0x7C, 0x10000000, 28 )] # CHOPCONF_M1
	DEDGE              = [( 0x6C, 0x20000000, 29 ) , ( 0x7C, 0x20000000, 29 )] # CHOPCONF_M1
	DISS2G             = [( 0x6C, 0x40000000, 30 ) , ( 0x7C, 0x40000000, 30 )] # CHOPCONF_M1
	TOFF               = [( 0x6C, 0x0000000F,  0 ) , ( 0x7C, 0x0000000F,  0 )] # CHOPCONF_M1
	TFD_2__0_          = [( 0x6C, 0x00000070,  4 ) , ( 0x7C, 0x00000070,  4 )] # CHOPCONF_M1
	OFFSET             = [( 0x6C, 0x00000780,  7 ) , ( 0x7C, 0x00000780,  7 )] # CHOPCONF_M1
	TFD__              = [( 0x6C, 0x00000800, 11 ) , ( 0x7C, 0x00000800, 11 )] # CHOPCONF_M1
	...
	DISS2G             = [( 0x6C, 0x40000000, 30 ) , ( 0x7C, 0x40000000, 30 )] # CHOPCONF_M1
	TOFF               = [( 0x6C, 0x0000000F,  0 ) , ( 0x7C, 0x0000000F,  0 )] # CHOPCONF_M1
	HSTRT              = [( 0x6C, 0x00000070,  4 ) , ( 0x7C, 0x00000070,  4 )] # CHOPCONF_M1
	HEND               = [( 0x6C, 0x00000780,  7 ) , ( 0x7C, 0x00000780,  7 )] # CHOPCONF_M1
	RNDTF              = [( 0x6C, 0x00002000, 13 ) , ( 0x7C, 0x00002000, 13 )] # CHOPCONF_M1
	CHM                = [( 0x6C, 0x00004000, 14 ) , ( 0x7C, 0x00004000, 14 )] # CHOPCONF_M1
	TBL                = [( 0x6C, 0x00018000, 15 ) , ( 0x7C, 0x00018000, 15 )] # CHOPCONF_M1
	VSENSE             = [( 0x6C, 0x00020000, 17 ) , ( 0x7C, 0x00020000, 17 )] # CHOPCONF_M1
	...
	# COOLCONF_M1
	SEMIN              = [( 0x6D, 0x0000000F,  0 ), ( 0x7D, 0x0000000F,  0 )]  # COOLCONF_M1
	SEUP               = [( 0x6D, 0x00000060,  5 ), ( 0x7D, 0x00000060,  5 )]  # COOLCONF_M1
	SEMAX              = [( 0x6D, 0x00000F00,  8 ), ( 0x7D, 0x00000F00,  8 )]  # COOLCONF_M1
	SEDN               = [( 0x6D, 0x00006000, 13 ), ( 0x7D, 0x00006000, 13 )]  # COOLCONF_M1
	SEIMIN             = [( 0x6D, 0x00008000, 15 ), ( 0x7D, 0x00008000, 15 )]  # COOLCONF_M1
	SGT                = [( 0x6D, 0x007F0000, 16 ), ( 0x7D, 0x007F0000, 16 )]  # COOLCONF_M1
	SFILT              = [( 0x6D, 0x01000000, 24 ), ( 0x7D, 0x01000000, 24 )]  # COOLCONF_M1

	# DCCTRL_M1
	DC_TIME            = [( 0x6E, 0x000003FF,  0 ), ( 0x7E, 0x000003FF,  0 )] # DCCTRL_M1
	DC_SG              = [( 0x6E, 0x00FF0000, 16 ), ( 0x7E, 0x00FF0000, 16 )] # DCCTRL_M1

	# DRV_STATUS_M1
	SG_RESULT          = [( 0x6F, 0x000003FF,  0 ), ( 0x7F, 0x000003FF,  0 )] # DRV_STATUS_M1
	FSACTIVE           = [( 0x6F, 0x00008000, 15 ), ( 0x7F, 0x00008000, 15 )] # DRV_STATUS_M1
	CS_ACTUAL          = [( 0x6F, 0x001F0000, 16 ), ( 0x7F, 0x001F0000, 16 )] # DRV_STATUS_M1
	STALLGUARD         = [( 0x6F, 0x01000000, 24 ), ( 0x7F, 0x01000000, 24 )] # DRV_STATUS_M1
	OT                 = [( 0x6F, 0x02000000, 25 ), ( 0x7F, 0x02000000, 25 )] # DRV_STATUS_M1
	OTPW               = [( 0x6F, 0x04000000, 26 ), ( 0x7F, 0x04000000, 26 )] # DRV_STATUS_M1
	S2GA               = [( 0x6F, 0x08000000, 27 ), ( 0x7F, 0x08000000, 27 )] # DRV_STATUS_M1
	S2GB               = [( 0x6F, 0x10000000, 28 ), ( 0x7F, 0x10000000, 28 )] # DRV_STATUS_M1
	OLA                = [( 0x6F, 0x20000000, 29 ), ( 0x7F, 0x20000000, 29 )] # DRV_STATUS_M1
	OLB                = [( 0x6F, 0x40000000, 30 ), ( 0x7F, 0x40000000, 30 )] # DRV_STATUS_M1
	STST               = [( 0x6F, 0x80000000, 31 ), ( 0x7F, 0x80000000, 31 )] # DRV_STATUS_M1
